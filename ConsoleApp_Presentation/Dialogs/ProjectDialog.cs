...
namespace ConsoleApp_Presentation.Dialogs;
...
public class ProjectDialog(IProjectService projectService) : IProjectDialog
{
    ...
    public async Task UpdateProjectOption()
    {
        ...
        else
        {
            ...
            //Denna kod för StartDate och EndDate genereras av ChatGpt.De läser först in datum som en string så att den ser till så att den inte är tom. Sedan konvertar den från en string till DateTime med hjölpen av (DateTime.TryParse). Om något har skrivits fel, så kommer ett felmeddelande skickas ut till användaren.
            ...
            // Denna kod genereras av ChatGpt. Koden konverterar en string till int då ID:et för mig är en int.
    ...
    public async Task MenuOptions()
    {
        while (true)
        {
            ...
            Console.WriteLine("6. Back to Main Menu for Exit the Program");
            ...
            switch (option)
            {
                ...
                case "6":
                    Console.WriteLine("Back to Main Menu for Exit the Program");
                    return;
            }
        }
    }
